...
(seq
  ...
  (setfield_imm 0 (field 0 (global camlCode!)) 1)
  (setfloatfield 0 (field 1 (global camlCode!)) 1.) 0a)
*** After TonClosure.optimize:
(let (z_int/1030 (makemutable 0 0))
  (seq (setfield_imm 0 (global camlCode!) z_int/1030)
    (let (z_float/1034 (makearray  0.))
      (seq (setfield_imm 1 (global camlCode!) z_float/1034)
        (setfield_imm 0 (field 0 (global camlCode!)) 1)
        (setfloatfield 0 (field 1 (global camlCode!)) 1.) 0a))))
...
(function camlCode__entry ()
 (let z_int/1030 (alloc 1024 1) (store "camlCode" z_int/1030)
   (let z_float/1034 (alloc 2302 0.) (store (+a "camlCode" 4) z_float/1034)
     (store (load "camlCode") 3) (store float64u (load (+a "camlCode" 4)) 1.)
     1a)))
